...
import { PlusCircle, Sparkles, Eye, ArrowRight, Package, Users } from "lucide-react";
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-gold-500/15">
        <div>
          <h1 className="text-2xl sm:text-3xl font-extrabold text-slate-100 flex items-center gap-2">
            Store Dashboard <span className="animate-pulse">📊</span>
          </h1>
          <p className="text-xs text-slate-400 mt-1">
            Rajdhani Home Decor • Real-time POS & Inventory Overview
          </p>
        </div>
        <Link href="/billing">
