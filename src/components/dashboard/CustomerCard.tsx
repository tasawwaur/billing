    ...
    >
      <div className="flex justify-between items-start">
        <div>
          ...
          <h3 className="text-2xl font-extrabold text-slate-100 mt-1" suppressHydrationWarning>{totalCustomers} Customers</h3>
        </div>
      ...
      <div className="mt-4 flex items-center justify-between text-xs pt-3 border-t border-gold-500/10 text-slate-300">
        ...
        <span className="font-bold text-gold-400" suppressHydrationWarning>{totalProducts} Items →</span>
      </div>
    </div>
  );
};
