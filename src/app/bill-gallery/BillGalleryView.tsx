...
export const BillGalleryView: React.FC = () => {
          ...
          {paginatedBills.length === 0 ? (
            <TableRow>
              <TableCell colSpan={8} className="text-center py-10 text-slate-400">
                {bills.length === 0
                  ? 'No invoices yet. Click "Create New Bill" or open POS to begin billing!'
            ...
            paginatedBills.map((bill) => (
              <TableRow key={bill.id}>
                ...
                <TableCell className="font-extrabold text-slate-100" suppressHydrationWarning>
